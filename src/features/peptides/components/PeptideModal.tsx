                        ...
                        <div className="grid grid-cols-1 gap-2">
                          {presets.map((preset) => (
                            <button
                              ...
                              className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all text-left w-full border-l-2 ${
                                isDarkMode
                                  ? 'bg-black/20 border-transparent hover:bg-[#B19CD9]/10'
                                  : 'bg-gray-100 border-transparent hover:bg-gray-200'
                              }`}
                              style={{ borderLeftColor: CATEGORY_COLORS[preset.category] }}
                            >
