    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#1a1625] via-[#2F2A4A] to-[#5B4B8A] animate-gradient-shift hide-scrollbar">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-black/40 backdrop-blur-xl border-b border-[#4ADEA8]/20 px-4 py-3 z-50 shadow-[0_4px_20px_rgba(74,222,168,0.15)]">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <h1 className="text-xl font-bold text-[#4ADEA8] [text-shadow:0_0_20px_rgba(74,222,168,0.5)]">GLPal</h1>
          <SettingsDropdown 
            profile={profile} 
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-black/40 backdrop-blur-xl border-t border-[#4ADEA8]/20 px-4 py-2 z-50 shadow-[0_-4px_20px_rgba(74,222,168,0.15)]">
        ...
        <div className="w-full max-w-md mx-auto px-4 py-2 space-y-3 md:max-w-2xl lg:max-w-4xl relative">
          <TabContent isActive={activeTab === 'dashboard'}>
            <>
               ...
               <div className="bg-black/30 backdrop-blur-lg rounded-2xl shadow-[0_8px_32px_rgba(156,123,211,0.2)] p-4 border border-[#9C7BD3]/20">
                 <h1 className="text-2xl font-bold text-[#4ADEA8] [text-shadow:0_0_20px_rgba(74,222,168,0.6)] mb-4">Dashboard</h1>
          ...
          <TabContent isActive={activeTab === 'weight'}>
            <>
              ...
              <div className="bg-black/30 backdrop-blur-lg rounded-2xl shadow-[0_8px_32px_rgba(156,123,211,0.2)] p-4 border border-[#9C7BD3]/20">
                <h3 className="text-sm font-semibold text-[#4ADEA8] mb-3 [text-shadow:0_0_10px_rgba(74,222,168,0.4)]">Add Today's Weight</h3>
            ...
            <>
              <div className="space-y-3">
                <header className="bg-black/30 backdrop-blur-lg rounded-2xl shadow-[0_8px_32px_rgba(156,123,211,0.2)] p-4 border border-[#9C7BD3]/20">
                  ...
                  <p className="text-sm text-[#4ADEA8]/80">Track your GLP-1 medication doses and monitor concentration levels.</p>
                </header>

                <div className="bg-black/30 backdrop-blur-lg rounded-2xl shadow-[0_8px_32px_rgba(156,123,211,0.2)] p-4 border border-[#9C7BD3]/20">
                  <h2 className="text-lg font-semibold text-[#4ADEA8] mb-3 [text-shadow:0_0_10px_rgba(74,222,168,0.4)]">GLP-1 Progress</h2>
                  <div className="h-64 sm:h-80">
                    <GLP1Chart data={glp1Entries} />
                  </div>
                </div>
