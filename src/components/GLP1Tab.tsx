  ...
  return (
    <div className="space-y-3">
      <header className={bigCard}>
        <h1 className={bigCardText.h1} style={{ textShadow: '0 0 20px var(--accent-purple-light)' }}>GLP-1 Tracking</h1>
        <p className="text-sm text-text-muted">Track your GLP-1 medication doses and monitor concentration levels.</p>
      </header>

      <div className={bigCard}>
        <h2 className={bigCardText.h2} style={{ textShadow: '0 0 10px var(--accent-purple-light)' }}>GLP-1 Progress</h2>
